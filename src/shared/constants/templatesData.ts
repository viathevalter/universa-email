...
/**
 * Templates Oficiais de Alta Conversão da UniversaTV:
 * Inclui os templates formais focados no serviço completo (deportes, series, lanzamientos y canales latinos/España)
 * otimizados com alto volume de texto e formatação profissional para máxima entregabilidade no Gmail.
 */
export const OFFICIAL_UNIVERSA_TEMPLATES: MarketingTemplate[] = [
  // 0.1 Template Geral 1: Solução All-in-One Completa (Direto ao Ponto - Teste 24h)
  {
    id: '00000000-0000-0000-0001-000000000091',
    tenant_id: '00000000-0000-0000-0000-000000000001',
    title: '⭐ [Servicio Completo] TV en español, canales latinos, deportes y cine (Prueba 24h Gratis)',
    subject: '📺 Acceso Total: TV en español, deportes y estrenos en 4K (Prueba 24h gratis)',
    category: 'servicio_completo',
    html_content: buildUniversaEmailHtml({
      badgeText: '⭐ UNIVERSATV - PRUEBA GRATIS 24H',
      headline: 'Todo el entretenimiento en un solo acceso para tu Smart TV o móvil',
      greeting: 'Hola <strong>{{nome}}</strong>, ¿cómo estás?',
      paragraphs: [
        'En <strong>UniversaTV</strong> reunimos todo lo que buscas en una sola aplicación: más de <strong>5.000 canales en directo</strong> (España y Latinoamérica), fútbol y deportes en vivo, y un catálogo con más de <strong>10.000 películas y series</strong> con estrenos diarios.',
        'Para que compruebes la calidad de imagen en <strong>4K sin cortes</strong> directamente en tu televisor, te activamos una <strong>prueba gratis de 24 horas</strong> sin ningún compromiso.',
      ],
      boxTitle: 'Lo que tendrás disponible en tu prueba de 24h:',
      boxItems: [
        '<strong>Fútbol y deportes en directo:</strong> LaLiga, Champions, ligas latinas y motor.',
        '<strong>+5.000 Canales en vivo:</strong> España y Latinoamérica (Colombia, México, Argentina, Perú, etc.).',
        '<strong>+10.000 Películas y Series:</strong> Estrenos recién salidos del cine y temporadas completas.',
        '<strong>Compatible con todo:</strong> Smart TV (Samsung, LG, Android TV), Fire Stick, móvil y PC.',
      ],
      ctaText: 'Pedir mi Prueba Gratis de 24h por WhatsApp',
      whatsappMessage: 'Hola Carlos! Quiero activar mi prueba gratis de 24 horas de UniversaTV. [Ref: T1-ServicioTotal]',
      secondaryNote: '⚡ Activación rápida en 5 minutos. No pedimos tarjeta de crédito ni datos bancarios.',
      senderName: 'Carlos Ventas',
      senderRole: 'Atención & Activaciones',
      senderRegion: 'UniversaTV Entertainment España',
  ...
  // 0.2 Template Geral 2: Foco em Esportes, Estreias e Estabilidade 4K (Direto ao Ponto)
  {
    id: '00000000-0000-0000-0001-000000000092',
    tenant_id: '00000000-0000-0000-0000-000000000001',
    title: '🚀 [Servicio Completo] Deportes en directo y estrenos 4K sin cortes (Prueba 24h Gratis)',
    subject: '⚽ Fútbol en directo, series y estrenos en 4K sin cortes (Tu prueba de 24h gratis)',
    category: 'servicio_completo',
    html_content: buildUniversaEmailHtml({
      badgeText: '🚀 MÁXIMA ESTABILIDAD 4K - SIN CORTES',
      headline: 'Disfruta del mejor fútbol, series y estrenos con señal 100% estable',
      greeting: 'Hola <strong>{{nome}}</strong>,',
      paragraphs: [
        '¿Cansado de transmisiones que se traban en el mejor momento o de buscar enlaces inestables? En <strong>UniversaTV</strong> contamos con servidores dedicados a <strong>60 fotogramas por segundo en 4K</strong> para que disfrutes de cada partido y película con máxima fluidez.',
        'Solicita tu <strong>acceso de prueba de 24 horas gratis</strong> y comprueba la calidad en tu televisor o celular antes de decidir nada.',
      ],
      boxTitle: 'Disponible en tu prueba gratuita:',
      boxItems: [
        '<strong>Señal fluida a 60 FPS:</strong> Toda LaLiga, Champions, Fórmula 1 y eventos mundiales.',
        '<strong>Cartelera al día:</strong> Últimos estrenos de cine y temporadas completas bajo demanda.',
        '<strong>Canales de España y Latinoamérica</strong> en directo y en alta definición.',
        '<strong>Instalación fácil:</strong> Te guiamos paso a paso por WhatsApp en menos de 5 minutos.',
      ],
      ctaText: 'Activar mi Prueba 24h en WhatsApp',
      whatsappMessage: 'Hola Carlos! Quiero probar la calidad 4K de UniversaTV con las 24 horas gratis. [Ref: T2-Estabilidad4K]',
      secondaryNote: 'Sin permanencia ni compromisos. Prueba 100% gratuita y libre de riesgos.',
      senderName: 'Carlos Ventas',
      senderRole: 'Soporte Técnico & Activaciones',
      senderRegion: 'UniversaTV Entertainment España',
      includePricing: false,
      isBrazil: false,
    }),
  ...
  // 0.3 Template Geral 3: Especial Residentes na Europa & Família (Direto ao Ponto)
  {
    id: '00000000-0000-0000-0001-000000000093',
    tenant_id: '00000000-0000-0000-0000-000000000001',
    title: '🌎 [Servicio Completo] La televisión de tu país en Europa: canales latinos y España (Prueba 24h)',
    subject: '🌎 Los canales de tu país en directo desde Europa (Pide tu prueba gratis 24h)',
    category: 'servicio_completo',
    html_content: buildUniversaEmailHtml({
      badgeText: '🌎 TU TELEVISIÓN EN ESPAÑOL EN EUROPA',
      headline: 'Los canales de tu tierra y la mejor televisión de España en tu salón',
      greeting: 'Hola <strong>{{nome}}</strong>, ¿qué tal estás?',
      paragraphs: [
        'Vivir en Europa no significa desconectarte de lo tuyo. En <strong>UniversaTV</strong> tienes las noticias, novelas y el fútbol de <strong>Colombia, México, Perú, Argentina, Venezuela, Chile</strong> y toda América Latina, junto con toda la televisión de España y cine familiar.',
        'Te invitamos a probar el servicio <strong>completamente gratis durante 24 horas</strong> directamente en tu televisor inteligente o teléfono.',
      ],
      boxTitle: 'Lo que incluye tu acceso de prueba:',
      boxItems: [
        '<strong>Canales nacionales latinos en vivo:</strong> Caracol, RCN, Telefe, Las Estrellas, Latina y más.',
        '<strong>Fútbol nacional e internacional:</strong> Eliminatorias, ligas locales, Libertadores y LaLiga.',
        '<strong>Cine y series infantiles y familiares</strong> bajo demanda en español.',
        '<strong>Multidispositivo:</strong> Smart TV, TV Box, Fire Stick, tablet o smartphone.',
      ],
      ctaText: 'Pide tu prueba gratis de 24h por WhatsApp',
      whatsappMessage: 'Hola Carlos! Vivo en Europa y quiero mi prueba gratis de 24 horas para ver los canales de mi país. [Ref: T3-EuropaLatinos]',
      secondaryNote: 'Activación guiada al instante por WhatsApp sin necesidad de tarjeta bancaria.',
      senderName: 'Carlos Ventas',
      senderRole: 'Atención a la Comunidad Hispana',
      senderRegion: 'UniversaTV Entertainment España',
      includePricing: false,
      isBrazil: false,
    }),
  ...
  // 1. LaLiga & Esportes em Geral (Espanha)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Quiero activar mi prueba gratuita de 24 horas para ver LaLiga y Champions en UniversaTV. [Ref: T1-LaLiga]',
  ...
  // 2. Real Madrid CF (Comunidade Madridista)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Soy madridista y quiero probar las 24 horas gratis de UniversaTV para el próximo partido. [Ref: T2-RealMadrid]',
  ...
  // 3. FC Barcelona (Comunidade Culé)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Soy culé y quiero mi prueba de 24 horas gratis para ver los partidos del Barça en UniversaTV. [Ref: T3-FCBarcelona]',
  ...
  // 4. Fórmula 1 & MotoGP (Motores)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Quiero activar mi prueba gratis de 24 horas para ver la Fórmula 1 y MotoGP en UniversaTV. [Ref: T4-MotoresF1]',
  ...
  // 5. Filmes e Séries (Cinefilos & Família)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      paragraphs: [
        ...
        'En <strong>UniversaTV Entertainment</strong> hemos reunido <strong>más de 10.000 películas e series completas bajo demanda</strong> en una única aplicación intuitiva y rápida para tu televisor.',
      ...
      whatsappMessage: 'Hola Carlos! Quiero probar el catálogo de películas y series de UniversaTV por 24 horas gratis. [Ref: T5-CineSeries]',
  ...
  // 6. Canais Latinos na Espanha / Europa (Comunidade Latina)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Vivo en Europa y quiero probar los canales de mi país en UniversaTV con las 24h gratis. [Ref: T6-CanalesLatinos]',
  ...
  // 7. Multidispositivo & Estabilidade Premium (Família / Geral)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Hola Carlos! Quiero probar el servicio multidispositivo de UniversaTV en mi Smart TV por 24 horas gratis. [Ref: T7-Multidispositivo]',
  ...
  // 8. Brasil & Brasileirão (Remetente Jackson Vendas)
  {
    ...
    html_content: buildUniversaEmailHtml({
      ...
      whatsappMessage: 'Olá Jackson! Quero ativar meu teste grátis de 24 horas do Brasileirão na Universa TV. [Ref: T8-Brasil]',
