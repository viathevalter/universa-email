...
<body style="margin: 0; padding: 0; background-color: #f4f6f9; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
  <div style="width: 100%; background-color: #f4f6f9; padding: 24px 12px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0; box-shadow: 0 4px 16px rgba(0,0,0,0.04);">
      ...
      <div style="padding: 24px 24px 18px 24px; text-align: center; border-bottom: 1px solid #f1f5f9; background-color: #ffffff;">
      ...
      <div style="padding: 28px 28px 24px 28px; color: #1e293b; font-size: 15px; line-height: 1.65;">
        
        <!-- Título Principal -->
        <h1 style="color: #0f172a; font-size: 21px; font-weight: 800; line-height: 1.35; margin: 0 0 16px 0; text-align: left;">
          ${headline}
        </h1>
        ...
        <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 18px 20px; margin: 24px 0;">
        ...
        <div style="text-align: center; margin: 28px 0 16px 0;">
          <a href="${whatsappUrl}" target="_blank" style="display: inline-block; background-color: #22c55e; background: linear-gradient(180deg, #22c55e 0%, #16a34a 100%); color: #ffffff; text-decoration: none; font-weight: 800; font-size: 16px; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 14px rgba(34, 197, 94, 0.35); text-align: center;">
            💬 ${ctaText}
          </a>
