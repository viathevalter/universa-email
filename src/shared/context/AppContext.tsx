...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const GENERATE_SCHEDULED_CAMPAIGNS = (tenantId = '00000000-0000-0000-0000-000000000001'): MarketingCampaign[] => {
    return [
      // TERÇA (08/09) - 6 Campanhas (4.400 envios)
      {
      ...
      },
      {
        ...
        title: '[HOJE (Ter 08/09) 15:30] 🇨🇴 Colombianos & América Latina (600 envios)',
      ...
      },
      {
        ...
        title: '[HOJE (Ter 08/09) 19:00] ⚽ LaLiga Santander & Champions 4K (750 envios)',
        ...
        target_audience_id: '00000000-0000-0000-0002-000000000001',
        status: 'scheduled',
        scheduled_at: '2026-09-08T17:00:00.000Z',
        total_recipients: 750,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      },
      {
        ...
        title: '[HOJE (Ter 08/09) 19:30] 👑 Real Madrid CF (800 envios)',
        ...
        status: 'scheduled',
        scheduled_at: '2026-09-08T17:30:00.000Z',
      ...
      },
      {
        ...
        title: '[HOJE (Ter 08/09) 19:45] 🔵🔴 FC Barcelona Culés (800 envios)',
        ...
        status: 'scheduled',
        scheduled_at: '2026-09-08T17:45:00.000Z',
        total_recipients: 800,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      },
      {
        ...
        title: '[HOJE (Ter 08/09) 20:30] 🎬 Cine & Séries On Demand (700 envios)',
        subject: '🎬 Todos los estrenos de cine y series en una sola app (Tu prueba de 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000005',
        status: 'scheduled',
        scheduled_at: '2026-09-08T18:30:00.000Z',
      ...
      // QUARTA (09/09) - 8 Campanhas (5.394 envios)
      {
        id: '00000000-0000-0001-0002-000000000001',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000007',
        title: '[AMANHÃ (Qua 09/09) 11:30] 📺 Multidispositivo Smart TV (750 envios)',
        subject: '📺 +5.000 Canales y Cine para toda tu familia en tu Smart TV (Prueba 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000001',
        status: 'scheduled',
        scheduled_at: '2026-09-09T09:30:00.000Z',
        total_recipients: 750,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0002-000000000002',
        tenant_id: tenantId,
        template_id: '327a5d0a-7165-4d49-b0d3-f8b527d82698',
        title: '[AMANHÃ (Qua 09/09) 15:30] 🇨🇴 Colombianos & América Latina (650 envios)',
        subject: '🌎 Todos los canales de tu país en vivo y en HD: Colombia, Perú, México, Argentina y más (Prueba 24h)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '04d519aa-23d5-4da3-a0bb-5f2030cfdb09',
        status: 'scheduled',
        scheduled_at: '2026-09-09T13:30:00.000Z',
      ...
      {
        id: '00000000-0000-0001-0002-000000000003',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000004',
        title: '[AMANHÃ (Qua 09/09) 18:00] 🏎️ Fórmula 1 & MotoGP (700 envios)',
        ...
        status: 'scheduled',
        scheduled_at: '2026-09-09T16:00:00.000Z',
        total_recipients: 700,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0002-000000000004',
        tenant_id: tenantId,
        template_id: '5667348d-1550-40c0-be71-f24e19568629',
        title: '[AMANHÃ (Qua 09/09) 19:15] 🇵🇹 Portugal & Desporto Nacional (444 envios)',
        subject: '📺 Todos os canais de Portugal, Sport TV e desporto em 4K sem pagar 80€/mês (Teste 24h Grátis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: 'af956243-0b6f-4fe6-abd5-e84e70820b83',
        status: 'scheduled',
        scheduled_at: '2026-09-09T17:15:00.000Z',
        total_recipients: 444,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
        clicked_count: 0,
      ...
      {
        id: '00000000-0000-0001-0002-000000000005',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000002',
        title: '[AMANHÃ (Qua 09/09) 19:30] 👑 Real Madrid CF (850 envios)',
        subject: '⚪ ¿Dónde ver al Real Madrid en directo y en 4K sin cortes? Prueba 24 Horas Gratis',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000002',
        status: 'scheduled',
        scheduled_at: '2026-09-09T17:30:00.000Z',
      ...
      {
        id: '00000000-0000-0001-0002-000000000006',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000003',
        title: '[AMANHÃ (Qua 09/09) 19:45] 🔵🔴 FC Barcelona Culés (850 envios)',
        subject: '🔵🔴 Vive cada partido del Barça en máxima calidad 4K (Test 24 Horas Gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000003',
        status: 'scheduled',
        scheduled_at: '2026-09-09T17:45:00.000Z',
        total_recipients: 850,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0002-000000000007',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000005',
        title: '[AMANHÃ (Qua 09/09) 20:30] 🎬 Cine & Séries On Demand (700 envios)',
        subject: '🎬 Todos los estrenos de cine y series en una sola app (Tu prueba de 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000005',
        status: 'scheduled',
        scheduled_at: '2026-09-09T18:30:00.000Z',
        total_recipients: 700,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0002-000000000008',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000008',
        title: '[AMANHÃ (Qua 09/09) 21:00] ⚽ Brasileirão, Premiere & +8.000 Canais (1.200 envios)',
        subject: '⚽ Brasileirão, Premiere e Filmes 4K sem travar (Seu Teste 24 Horas Grátis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '85e03b3a-c34f-4cbf-b80f-fbbd0beb3399',
        status: 'scheduled',
        scheduled_at: '2026-09-09T19:00:00.000Z',
      ...
      // QUINTA (10/09) - 9 Campanhas (5.867 envios)
      {
        id: '00000000-0000-0001-0003-000000000001',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000007',
        title: '[QUINTA (10/09) 11:30] 📺 Multidispositivo Smart TV (750 envios)',
        subject: '📺 +5.000 Canales y Cine para toda tu familia en tu Smart TV (Prueba 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '327a5d0a-7165-4d49-b0d3-f8b527d82698',
        title: '[QUINTA (10/09) 15:30] 🇨🇴 Colombianos & América Latina (673 envios)',
        subject: '🌎 Todos los canales de tu país en vivo y en HD: Colombia, Perú, México, Argentina y más (Prueba 24h)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '04d519aa-23d5-4da3-a0bb-5f2030cfdb09',
        status: 'scheduled',
        scheduled_at: '2026-09-10T13:30:00.000Z',
        total_recipients: 673,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
        clicked_count: 0,
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000004',
        title: '[QUINTA (10/09) 18:00] 🏎️ Fórmula 1 & MotoGP (750 envios)',
        subject: '🏎️ Toda la temporada de Fórmula 1 y MotoGP en directo (Prueba 24 Horas Gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
      ...
      {
        id: '00000000-0000-0001-0003-000000000004',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000001',
        title: '[QUINTA (10/09) 19:00] ⚽ LaLiga Santander & Champions 4K (750 envios)',
        subject: '⚽ ¿Ver todo el fútbol y Champions en 4K sin pagar 120€/mes? (Prueba 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000001',
        status: 'scheduled',
        scheduled_at: '2026-09-10T17:00:00.000Z',
        total_recipients: 750,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0003-000000000005',
        tenant_id: tenantId,
        template_id: '5667348d-1550-40c0-be71-f24e19568629',
        title: '[QUINTA (10/09) 19:15] 🇵🇹 Portugal & Desporto Nacional (444 envios)',
        subject: '📺 Todos os canais de Portugal, Sport TV e desporto em 4K sem pagar 80€/mês (Teste 24h Grátis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: 'af956243-0b6f-4fe6-abd5-e84e70820b83',
        status: 'scheduled',
        scheduled_at: '2026-09-10T17:15:00.000Z',
        total_recipients: 444,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0003-000000000006',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000002',
        title: '[QUINTA (10/09) 19:30] 👑 Real Madrid CF (850 envios)',
        subject: '⚪ ¿Dónde ver al Real Madrid en directo y en 4K sin cortes? Prueba 24 Horas Gratis',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000002',
        status: 'scheduled',
        scheduled_at: '2026-09-10T17:30:00.000Z',
        total_recipients: 850,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0003-000000000007',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000003',
        title: '[QUINTA (10/09) 19:45] 🔵🔴 FC Barcelona Culés (850 envios)',
        subject: '🔵🔴 Vive cada partido del Barça en máxima qualidade 4K (Test 24 Horas Gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000003',
        status: 'scheduled',
        scheduled_at: '2026-09-10T17:45:00.000Z',
        total_recipients: 850,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0003-000000000008',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000005',
        title: '[QUINTA (10/09) 20:30] 🎬 Cine & Séries On Demand (700 envios)',
        subject: '🎬 Todos los estrenos de cine y series en una sola app (Tu prueba de 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000005',
        status: 'scheduled',
        scheduled_at: '2026-09-10T18:30:00.000Z',
        total_recipients: 700,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      {
        id: '00000000-0000-0001-0003-000000000009',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000008',
        title: '[QUINTA (10/09) 21:00] ⚽ Brasileirão, Premiere & +8.000 Canais (1.200 envios)',
        subject: '⚽ Brasileirão, Premiere e Filmes 4K sem travar (Seu Teste 24 Horas Grátis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
      ...
      // SEXTA (11/09) - 5 Campanhas (5.319 envios)
      {
        id: '00000000-0000-0001-0004-000000000001',
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000007',
        title: '[SEXTA (11/09) 11:30] 📺 Multidispositivo Smart TV (750 envios)',
        subject: '📺 +5.000 Canales y Cine para toda tu familia en tu Smart TV (Prueba 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000001',
        status: 'scheduled',
        scheduled_at: '2026-09-11T09:30:00.000Z',
        total_recipients: 750,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000004',
        title: '[SEXTA (11/09) 18:00] 🏎️ Fórmula 1 & MotoGP (Treinos Livres) (750 envios)',
        subject: '🏎️ Toda la temporada de Fórmula 1 y MotoGP en directo (Prueba 24 Horas Gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000004',
        status: 'scheduled',
        scheduled_at: '2026-09-11T16:00:00.000Z',
        total_recipients: 750,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000001',
        title: '[SEXTA (11/09) 19:00] ⚽ LaLiga Santander & Fim de Semana (1.500 envios)',
        subject: '⚽ ¿Ver todo el fútbol y Champions en 4K sin pagar 120€/mes? (Prueba 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000001',
        status: 'scheduled',
        scheduled_at: '2026-09-11T17:00:00.000Z',
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000005',
        title: '[SEXTA (11/09) 20:30] 🎬 Cine & Séries Fim de Semana (700 envios)',
        subject: '🎬 Todos los estrenos de cine y series en una sola app (Tu prueba de 24h gratis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '00000000-0000-0000-0002-000000000005',
        status: 'scheduled',
        scheduled_at: '2026-09-11T18:30:00.000Z',
        total_recipients: 700,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
      ...
      },
      {
        ...
        tenant_id: tenantId,
        template_id: '00000000-0000-0000-0001-000000000008',
        title: '[SEXTA (11/09) 21:00] ⚽ Brasileirão Pré-Rodada Fim de Semana (2.369 envios)',
        subject: '⚽ Brasileirão, Premiere e Filmes 4K sem travar (Seu Teste 24 Horas Grátis)',
        sender_name: 'Carlos Ventas - Universa TV España',
        sender_email: 'carlos_ventas@mail.universatv.com',
        reply_to: 'carlos_ventas@mail.universatv.com',
        target_audience_id: '85e03b3a-c34f-4cbf-b80f-fbbd0beb3399',
        status: 'scheduled',
        scheduled_at: '2026-09-11T19:00:00.000Z',
        total_recipients: 2369,
        sent_count: 0,
        delivered_count: 0,
        opened_count: 0,
        clicked_count: 0,
  ...
  const [campaigns, setCampaigns] = useState<MarketingCampaign[]>(() => {
    try {
      ...
      const initial = GENERATE_SCHEDULED_CAMPAIGNS(DEFAULT_TENANT.id);
      safeStorageSet(STORAGE_KEYS.CAMPAIGNS, initial);
      return initial;
    } catch {
      return GENERATE_SCHEDULED_CAMPAIGNS(DEFAULT_TENANT.id);
    }
  });
