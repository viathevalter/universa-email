  ...
  const templatesToInsert = [
    {
      ...
      preview_text: 'Todo el entretenimiento en un solo acceso para tu Smart TV o móvil',
    ...
    },
    {
      ...
      preview_text: 'Disfruta del mejor fútbol, series y estrenos con señal 100% estable',
      variables: ['{{nome}}', '{{cidade}}', '{{link_descadastro}}'],
      html_content: buildUniversaEmailHtml({
    ...
    },
    {
      ...
      preview_text: 'Los canales de tu tierra y la mejor televisión de España en tu salón',
      variables: ['{{nome}}', '{{cidade}}', '{{link_descadastro}}'],
      html_content: buildUniversaEmailHtml({
